...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cms/template/list">模板列表</a></li>
		<li class="active"><a href="${ctx}/cms/template/form?id=${template.id}">模板<shiro:hasPermission name="cms:template:form">${not empty template.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cms:template:form">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="template" action="${ctx}/cms/template/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="cms:template:save"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
