...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cms/htmlPage/list">页面列表</a></li>
		<li class="active"><a href="${ctx}/cms/htmlPage/form?id=${htmlPage.id}">页面<shiro:hasPermission name="cms:htmlPage:form">${not empty htmlPage.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cms:htmlPage:form">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="htmlPage" action="${ctx}/cms/htmlPage/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="description" htmlEscape="false" maxlength="256" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="showUrl" htmlEscape="false" maxlength="128" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">json_type：</label>
			<div class="controls">
				<form:input path="jsonType" htmlEscape="false" maxlength="1" class="input-xlarge required digits"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="cms:htmlPage:save"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
