...
<body>
	...
	<form id="assignRoleForm" action="${ctx}/sys/role/assignrole" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li class="btns"><input id="assignButton" class="btn btn-primary" type="button" value="分配角色"/></li>
		</ul>
	</form>
