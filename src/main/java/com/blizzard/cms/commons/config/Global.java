 ...
 */
package com.blizzard.cms.commons.config;

import com.blizzard.cms.commons.utils.PropertiesLoader;
...
public class Global {
	...
	public static String getCloudPrivateSpace(){
		return getConfig("cloud_private_space");
	}
