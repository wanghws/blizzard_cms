 ...
 */
package com.blizzard.cms.commons.utils;
...
public class Page<T> {
	...
	public Page(HttpServletRequest request, HttpServletResponse response, int defaultPageSize){
		...
		}else if(request.getRequestURI().indexOf("/crm") >=0
				|| request.getRequestURI().indexOf("/erp") >=0
				|| request.getRequestURI().indexOf("/school") >=0 ){
			this.setOrderBy(" a.create_time desc");
		}
	}
