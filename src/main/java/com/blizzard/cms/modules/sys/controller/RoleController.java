...
import com.blizzard.cms.modules.sys.service.OfficeService;
...
import com.blizzard.cms.commons.utils.Collections3;
...
//			}
	...
	public String assignRole(Role role, String[] idsArr, RedirectAttributes redirectAttributes) {
		...
		for (int i = 0; i < idsArr.length; i++) {
			if (Strings.isNullOrEmpty(idsArr[i]))continue;

			User user = systemService.assignUserToRole(role, systemService.getUser(Long.parseLong(idsArr[i])));
			if (null != user) {
